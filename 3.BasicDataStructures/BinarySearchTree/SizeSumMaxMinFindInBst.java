...
public class SizeSumMaxMinFindInBst {
    ...
    public static int size(Node node) {
        ...
        int left_side = size(node.left);
        int right_side = size(node.right);

        int total = left_side + right_side + 1;
    ...
    public static int sum(Node node) {
        ...
        int left_side = sum(node.left);
        int right_side = sum(node.right);

        int total = left_side + right_side + node.data;
        return total;
    }
