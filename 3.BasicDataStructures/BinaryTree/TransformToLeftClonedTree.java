...
public class TransformToLeftClonedTree {
    ...
    public static Node createLeftCloneTree(Node node) {
        ...
        Node left_hand_clone = createLeftCloneTree(node.left);
        Node right_hand_clone = createLeftCloneTree(node.right);

        Node new_node = new Node(node.data, left_hand_clone, null);
        node.left = new_node;
        node.right = right_hand_clone;
