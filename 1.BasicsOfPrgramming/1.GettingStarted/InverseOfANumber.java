...
public class InverseOfANumber {
    public static void main(String[] args) {
        ...
        // the digits from 1 to 5 without missing any and without repeating any. e.g.
        // 23415 is a 5 digit long number containing all digits from 1 to 5 without
        // missing and repeating any digit from 1 to 5.Take a look at few other valid
        // numbers - 624135, 81456273 etc.Here are a few invalid numbers - 139, 7421357
        // etc.
        ...
        while (n != 0) {
            ...
            answer += position * (int) Math.pow(10, digit - 1);
